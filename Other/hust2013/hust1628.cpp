...
inline int query(int t,int d,int x,int y,int k)
{
    ...
    if(s>=k)
    {
        int xx=l+ss;//��Ȼ[x,y]�ľ͹��ˣ�[l,x-1]�Ͳ���������ss����û���ˡ�
        int yy=l+ss+s-1;//����һ�ε�s��1
        return query(t*2,d+1,xx,yy,k);
    }
    else
    {
        int r1=x-l-ss;//[l,x-1]֮�䱻�ֵ�������
        int r2=y-x+1-s;//[x,y]֮�䱻�ֵ�������
        int xx=m+1 +r1;
        int yy=m+1 +r1+r2-1;
